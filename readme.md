...
Quét và liệt kê tất cả thiết bị đang kết nối vào mạng nội bộ theo thời gian thực. Hiển thị IP, MAC address, hostname, nhà sản xuất. Hỗ trợ đặt tên và ghi chú cho từng thiết bị. Block/unblock thiết bị theo MAC address áp dụng ngay lập tức.
...
**Thông tin WiFi**
Xem SSID, cường độ tín hiệu, kênh phát, băng tần, số lượng thiết bị đang kết nối và các thông số mạng WiFi cục bộ.
